...
<body>
    ...
    <a href="http://localhost:8080/querystring?name=%EA%B6%8C%EC%9D%80%ED%98%9C&age=1&birthday=2024-07-10&gender=F&national=ko&hobbies=movie&hobbies=music&hobbies=sleep">
        쿼리스트링을 이용한 값 전달
    </a>
